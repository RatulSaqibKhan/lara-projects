...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{ asset('theme/base/css/adminlte.min.css') }}">
  <!-- overlayScrollbars -->
...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <!-- Preloader -->
    @include('components.private.preloaders.base')

    <!-- Navbar -->
    @include('components.private.navbars.base')
    <!-- /.navbar -->

    <!-- Main Sidebar Container -->
    @include('components.private.sidebars.base')
    ...
    <!-- /.content-wrapper -->
    @include('components.private.footers.base')
    @include('components.private.sidebars.right.base')
  ...
  <!-- AdminLTE App -->
  <script src="{{ asset('theme/base/js/adminlte.js') }}"></script>
  <!-- AdminLTE for demo purposes -->
  <script src="{{ asset('theme/base/js/demo.js') }}"></script>
  <!-- AdminLTE dashboard demo (This is only for demo purposes) -->
  <script src="{{ asset('theme/base/js/pages/dashboard.js') }}"></script>
